# add column
ALTER TABLE `zpar_master_data` ADD `Availability Check change` VARCHAR(20) NULL AFTER `Availability Check`;
ALTER TABLE `zpar_master_data` ADD `Safety stock change` VARCHAR(20) NULL AFTER `Safety stock`;
ALTER TABLE `zpar_master_data` ADD `Safety time ind change` VARCHAR(20) NULL AFTER `Safety time ind`;
ALTER TABLE `zpar_master_data` ADD `Takt time change` VARCHAR(20) NULL AFTER `Takt time`;
ALTER TABLE `zpar_master_data` ADD `Maximum stock level change` VARCHAR(20) NULL AFTER `Maximum stock level`;
ALTER TABLE `zpar_master_data` ADD `Lot size key change` VARCHAR(20) NULL AFTER `Lot size key`;
ALTER TABLE `zpar_master_data` ADD `Rounding Value change` VARCHAR(20) NULL AFTER `Rounding Value`;
ALTER TABLE `zpar_master_data` ADD `Maximum Lot size change` VARCHAR(20) NULL AFTER `Maximum Lot size`;
ALTER TABLE `zpar_master_data` ADD `Minimum Lot size change` VARCHAR(20) NULL AFTER `Minimum Lot size`;
ALTER TABLE `zpar_master_data` ADD `Procurement Type change` VARCHAR(20) NULL AFTER `Procurement Type`;
ALTER TABLE `zpar_master_data` ADD `three_check` VARCHAR(20) NULL AFTER `Effective Out Date`;
ALTER TABLE `zpar_master_data` ADD `Quota Arrangement us change` VARCHAR(20) NULL AFTER `Quota Arrangement us`;
ALTER TABLE `zpar_master_data` ADD `InhseProdnTime change` VARCHAR(20) NULL AFTER `InhseProdnTime`;
ALTER TABLE `zpar_master_data` ADD `Goods receipt procc change` VARCHAR(20) NULL AFTER `Goods receipt procc`;
ALTER TABLE `zpar_master_data` ADD `Schedule Margin key change` VARCHAR(20) NULL AFTER `Schedule Margin key`;
ALTER TABLE `zpar_master_data` ADD `Period Indicator change` VARCHAR(20) NULL AFTER `Period Indicator`;
ALTER TABLE `zpar_master_data` ADD `Planned delivery tim change` VARCHAR(20) NULL AFTER `Planned delivery tim`;
ALTER TABLE `zpar_master_data` ADD `Selection Method change` VARCHAR(20) NULL AFTER `Selection Method`;
ALTER TABLE `zpar_master_data` ADD `Prod.Sched.Profile change` VARCHAR(20) NULL AFTER `Prod.Sched.Profile`;
...
# Discontinuation ind /  Follow up ind / Effective Out Date
